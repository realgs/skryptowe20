        ...
        <>
            ...
            <p>
                <Text>
                    ...
                    asgiref==3.3.1
                    <br></br>certifi==2020.12.5
                    <br></br>chardet==3.0.4
                    <br></br>Django==3.1.4
                    <br></br>djangorestframework==3.12.2
                    <br></br>idna==2.10
                    <br></br>pytz==2020.4
                    <br></br>requests==2.25.0
                    <br></br>sqlparse==0.4.1
                    <br></br>urllib3==1.26.2
            ...
            <Title level={3}>Setup</Title>
                ...
                <Text>
                    <p>1. Download <a href="https://github.com/jpwhite3/northwind-SQLite3/blob/master/Northwind_large.sqlite.zip">Northwind sqlite3 database</a>. <br></br>
                    2. Make sure the path to the database is correct in <i>constants.py</i><br></br>
            ...
            <Title level={3}>Usage</Title>
                ...
                <Text>
                    ...
                    <p>Where:</p>
                    <b>currency</b> - supported currency code, specified as <b>SUMMARY_SUPPORTED_CURRENCIES</b> in <i>constants.py</i> <br></br>
                    <b>start_date</b> - beginning of period, in format YYYY-MM-DD, <br></br>
                ...
                <Text>
                    ...
                    <p>Where:</p>
                    <b>currency</b> - supported currency code, specified as <b>SUMMARY_SUPPORTED_CURRENCIES</b> <i>constants.py</i> <br></br>
                    <b>start_date</b> - beginning of period, in format YYYY-MM-DD, <br></br>
                    <b>end_date</b> - end of period, in format YYYY-MM-DD
                    ...
                    <p>Where:</p>
                    <b>original_sum</b> - sum of all transactions in the original value. <br></br>
            ...
            <Title level={3}>Errors</Title>
                <Text>
                    ...
                    <b>Incorrect date</b> - input date format is not correct <br></br>
                    <b>Unsupported currency</b> - currency is not on supported currencies list <br></br>
                    <b>Incorrect input</b> - other input error <br></br>
                    <b>Start date should be smaller than end date</b> - start date should be smaller than end date <br></br>
                    <b>Internal database error</b> - something went wrong with database connection within our system<br></br>
                    <b>Requests limit reached</b> - limit of requests per minute was reached <br></br>
